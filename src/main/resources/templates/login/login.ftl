...
<div class="cotn_principal">
  <div class="cont_centrar" style="top:5%;">
    <div class="cont_login">
      <div class="cont_forms cont_forms_active_login" style="height: 500px;width: 400px;border-radius: 15px;">
        ...
        <div class="cont_form_login" style="display: block;opacity: 1;width: 400px;">
          ...
          <h2>用户登录</h2>
          <input type="text" placeholder="用户名" autofocus="autofocus" value="${(userName)!''}" name="userName" class="userName test"/>
       ...
       <div><a href="/regists" class="btn_login btn">注册</a></div>
        </div>
        </form>
      </div>
